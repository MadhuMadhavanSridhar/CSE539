...
private:
	...
	const vector<vector<unsigned char>> sbox = 
	    {
	...
	void validateVect(vector<vector<unsigned char>> vectInput);
	...
	void AddRoundKey(int rround, vector<vector<unsigned char>> KeyExpansion);
	void invAddRoundKey(int rround, vector<vector<unsigned char>> KeyExpansion);
	void subBytes();
	void invSubBytes();
    void ShiftRows();
	void invShiftRows();
...
public:
	AESState();
	AESState(string hexInput);
	AESState(string hexInput, int inputNk);
	AESState(vector<vector<unsigned char>> input);
	AESState(vector<vector<unsigned char>> input, int inputNk);
